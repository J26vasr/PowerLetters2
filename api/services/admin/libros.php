    ...
    if (isset($_SESSION['idAdministrador'])) {
        ...
        switch ($_GET['action']) {
            ...
            case 'deleteRow': // Acción para eliminar una fila por ID.
                ...
                break;
                case 'porcentajeProductosEditorial':
                    if ($result['dataset'] = $libros->porcentajeProductosEditorial()) {
                        $result['status'] = 1;
                    } else {
                        $result['error'] = 'No hay datos disponibles';
                    }
                    break;
                    case 'cantidadProductosEditorial':
                        if ($result['dataset'] = $libros->cantidadProductosEditorial()) {
                            $result['status'] = 1;
                        } else {
                            $result['error'] = 'No hay datos disponibles';
                        }
                        ...
                        case 'porcentajeLibrosAutores':
                            if ($result['dataset'] = $libros->porcentajeLibrosAutores()) {
                                $result['status'] = 1;
                            } else {
                                $result['error'] = 'No hay datos disponibles';
                            }
