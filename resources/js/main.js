...
// Solo se ejecuta el bloque del theme si el boton existe en la pagina actual.
// En paginas donde el header se inyecta via loadTemplate(), public.js se encarga del theme.
if (themeButton) {
